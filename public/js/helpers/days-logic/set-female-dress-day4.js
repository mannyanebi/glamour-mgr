function setFemaleDressDay4(weatherSummary) {
    if (weatherSummary) {
    ...
    document.querySelector("#female-dress-day4").appendChild(female_dress_img);    
    } else {
        ...
        document.querySelector("#female-dress-day4").setAttribute('style', 'display:none');
        document.querySelector("#dresses-container-day4").appendChild(errMsg);
    }
