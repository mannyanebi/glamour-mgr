function setMaleDressDay7(weatherSummary, summaryInfo) {
    if (weatherSummary) {
    ...
    document.querySelector("#male-dress-day7").appendChild(male_dress_img);
       
    //for summary information gotten from server
    document.querySelector('#summary-info-day7').innerHTML = summaryInfo;

    } else {
        //remove male dress div so that nothing will display since
        //no data was received from the server
        document.querySelector("#male-dress-day7").setAttribute('style', 'display:none');
        document.querySelector('#summary-info-day7').setAttribute('style', 'display:none');
    }
