function setFemaleDressDay2(weatherSummary) {
    if (weatherSummary) {
    ...
    document.querySelector("#female-dress-day2").appendChild(female_dress_img);
        ...
        document.querySelector("#female-dress-day2").setAttribute('style', 'display:none');
        document.querySelector("#dresses-container-day2").appendChild(errMsg);
    }
}