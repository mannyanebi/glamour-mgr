function setFemaleDressDay3(weatherSummary) {
    if (weatherSummary) {
    ...
    document.querySelector("#female-dress-day3").appendChild(female_dress_img);    
    } else {
        ...
        document.querySelector("#female-dress-day3").setAttribute('style', 'display:none');
        document.querySelector("#dresses-container-day3").appendChild(errMsg);
    }
}