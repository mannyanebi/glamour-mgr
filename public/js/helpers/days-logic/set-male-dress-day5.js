function setMaleDressDay5(weatherSummary, summaryInfo) {
    if (weatherSummary) {
    ...
    document.querySelector("#male-dress-day5").appendChild(male_dress_img);    
    
    //for summary information gotten from server
    document.querySelector('#summary-info-day5').innerHTML = summaryInfo;
    } else {
        //remove male dress div so that nothing will display since
        //no data was received from the server
        document.querySelector("#male-dress-day5").setAttribute('style', 'display:none');
        document.querySelector('#summary-info-day5').setAttribute('style', 'display:none');
    }
