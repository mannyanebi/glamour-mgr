function setFemaleDressDay5(weatherSummary) {
    if (weatherSummary) {
    ...
    document.querySelector("#female-dress-day5").appendChild(female_dress_img);    
    } else {
        ...
        document.querySelector("#female-dress-day5").setAttribute('style', 'display:none');
        document.querySelector("#dresses-container-day5").appendChild(errMsg);
    }
